  ...
  return (
    <main className="min-h-screen">
      <HeroSection
        ...
        subheadline="Finally work in your timezone while staying perfectly synced with global teams. LocalSphere transforms every meeting into an async conversation, every decision into a searchable thread, and every update into instant notification—no more calendar chaos."
      />
      ...
      <footer className="bg-gray-900 text-white py-12 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-4">
            Join remote-first teams who&apos;ve reclaimed their sleep schedules with LocalSphere
          </p>
